...
== Upgrade Notice ==
= 1.6 =
* Updates for WordPress 5.0 and Twenty Fourteen 2.3, 2.4, 2.5.

= 1.5 =
* Update color patterns to address changes in Twenty Fourteen 2.0, 2.1, 2.2 and WordPress 4.8 and 4.9.
